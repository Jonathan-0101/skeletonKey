...
enum { E_PG_BASE,
       ...
       E_PG_IR,
       E_Popup_Boot,
       E_Popup_HandshakeCapture };
enum { BLE_Button_Send,
       Base_Button_home,
       Base_Button_settings,
       Base_Line_topBar,
       Base_Text_Bat,
       Base_Text_PageLabel,
       Boot_Image_logo,
       HandshakeCapture_Box_background,
       HandshakeCapture_Button_active,
       HandshakeCapture_Button_exit,
       HandshakeCapture_Button_passive,
       HandshakeCapture_Text_title,
       IR_Button_Back,
       IR_Button_Capture,
       IR_Button_Jam,
       IR_Button_Select,
       IR_Listbox_stored,
       IR_Listscroll_stored,
       Main_Button_BLE,
       Main_Button_BadUSB,
       Main_Button_IR,
       Main_Button_RFID,
       Main_Button_SubGHz,
       Main_Button_WIFI,
       Settings_Button_calibrateTouch,
       Settings_Button_vibrationToggle,
       SubGHz_Button_capture,
       SubGHz_Button_frequency,
       SubGHz_Button_jaming,
       SubGHz_Button_transmit,
       SubGHz_Listbox_signals,
       SubGHz_Listscroll_signals,
       WiFi_Button_deauth,
       WiFi_Button_handshake,
       WiFi_Button_rickRollBeacon,
       WiFi_Button_scanNetworks,
